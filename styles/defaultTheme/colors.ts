const colors = {
  ...
  taskbar: {
    active: "hsla(0, 0%, 15%, 90%)",
    activeForeground: "hsla(0, 0%, 22%, 90%)",
    ai: {
      balanced: ["rgb(0, 150, 255)", "rgb(0, 100, 225)", "rgb(0, 50, 200)"],
      creative: ["rgb(150, 100, 255)", "rgb(100, 50, 200)", "rgb(50, 0, 150)"],
      precise: ["rgb(0, 200, 255)", "rgb(0, 150, 200)", "rgb(0, 100, 150)"],
    },
    background: "hsla(0, 0%, 10%, 90%)",
    button: {
      color: "#FFF",
    },
    foreground: "hsla(0, 0%, 18%, 90%)",
    foregroundHover: "hsla(0, 0%, 25%, 90%)",
    foregroundProgress: "hsla(0, 0%, 20%, 30%)",
    hover: "hsla(0, 0%, 15%, 90%)",
    peekBorder: "hsla(0, 0%, 25%, 50%)",
  },
